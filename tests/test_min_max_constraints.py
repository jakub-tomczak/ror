...
class TestMinMaxValueConstraint(unittest.TestCase):
    def test_creating_min_value_constraints(self):
        ...
        self.assertAlmostEqual(min_constraints[0].get_variable('b05').coefficient, 1.0)
        ...
        self.assertAlmostEqual(min_constraints[1].get_variable('b02').coefficient, 1.0)
        self.assertAlmostEqual(
    ...
    def test_creating_max_value_constraints(self):
        ...
        self.assertAlmostEqual(max_constraint.get_variable('b02').coefficient, 1.0)
        self.assertIsNotNone(max_constraint.get_variable('b03'))
        self.assertAlmostEqual(max_constraint.get_variable('b03').coefficient, 1.0)
